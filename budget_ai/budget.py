"""In-memory budget tracker for budget-ai.
...
from budget_ai.types import BudgetStatus, CostReport, TokenUsage
...
class InMemoryBudgetTracker:
    ...
    Satisfies :class:`~budget_ai.protocols.BudgetTracker` via
